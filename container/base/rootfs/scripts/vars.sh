...
GAMESERVER_SERVER_SUBTYPE="${GAMESERVER_SERVER_SUBTYPE:-unset}"
...
SERVER_TEMPLATE_ENABLED="${SERVER_TEMPLATE_ENABLED:-false}"
SERVER_TEMPLATE_BASE_DIR="${SERVER_TEMPLATE_BASE_DIR:-/templates}"
SERVER_TEMPLATE_PATH="${SERVER_TEMPLATE_PATH:-${SERVER_TEMPLATE_BASE_DIR}/${GAMESERVER_SERVER_NAME_WONUM}}"
SERVER_TEMPLATE_MODE="${SERVER_TEMPLATE_MODE:-random}" # `random` or `ordered` mode
